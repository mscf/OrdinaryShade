    ...
    if isinstance(value, Attribute):
        ...
        if (
            ...
            and value.attribute in {
                ...
                "subgroup_broadcast_first", "atomic_add", "atomic_compare_exchange", "atomic_exchange", "atomic_or",
            ...
            return {
                ...
                "atomic_add": "atomicAdd", "atomic_compare_exchange": "atomicCompSwap", "atomic_exchange": "atomicExchange", "atomic_or": "atomicOr",
